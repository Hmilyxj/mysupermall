...
export default {
 ...
 this.$bus.$off('ImageLoad',this.refresh);
  ...
  created() {
    ...
    this.getThemeOffsetY = debounce(() => {
      this.themeOffsetY = [];
      this.themeOffsetY.push(this.$refs.swiper.$el.offsetTop);
      this.themeOffsetY.push(this.$refs.paramInfo.$el.offsetTop);
